...
const grammarTopics: Array<{
  ...
  },
  {
    ...
    content: [
      {
        subtitle: "1. Basic Word Order - Asosiy so'z tartibi (SVO)",
        colorIndex: 0,
        rules: [
          "Ingliz tilida asosiy tartib: Subject + Verb + Object (SVO)",
          "Example: I (S) eat (V) breakfast (O) - Men nonushta qilaman",
          "Example: She (S) reads (V) books (O) - U kitob o'qiydi",
          "Example: They (S) play (V) football (O) - Ular futbol o'ynaydi",
          "📝 SIFAT + OT tartibi:",
          "Sifat doim otdan oldin keladi: a big house, a red car, a beautiful girl",
          "Bir necha sifat: opinion + size + age + shape + color + origin + material",
          "Example: a beautiful small old round red Italian wooden table",
          "📝 RAVISH tartibi:",
          "Manner (qanday) + Place (qayerda) + Time (qachon)",
          "Example: She sang beautifully at the concert last night",
          "Frequency adverbs (always, often, never) - fe'ldan oldin",
          "Example: I always wake up early. She never eats meat.",
        ],
      },
      {
        subtitle: "2. Question Formation - So'roq gap tuzish",
        colorIndex: 1,
        rules: [
          "📝 YES/NO QUESTIONS:",
          "Auxiliary + Subject + Verb + Object?",
          "Do you like coffee? - Qahva yoqadimi?",
          "Does she work here? - U bu yerda ishlaydimi?",
          "Is he coming? - U kelyaptimi?",
          "Are they ready? - Ular tayyormi?",
          "Have you finished? - Tugatdingizmi?",
          "📝 WH-QUESTIONS:",
          "WH-word + Auxiliary + Subject + Verb?",
          "What do you want? - Nima xohlaysiz?",
          "Where does she live? - U qayerda yashaydi?",
          "When did they arrive? - Ular qachon keldi?",
          "Why are you crying? - Nega yig'layapsiz?",
          "How did you do it? - Buni qanday qildingiz?",
          "Who called you? - Kim qo'ng'iroq qildi? (bu yerda auxiliary kerak emas)",
          "📝 QUESTION WORDS:",
          "What (nima), Where (qayerda), When (qachon), Why (nega)",
          "Who (kim), Whose (kimning), Which (qaysi), How (qanday)",
          "How much (qancha - sanoqsiz), How many (nechta - sanoqli)",
          "How long (qancha vaqt), How often (qanchalik tez-tez), How far (qanchalik uzoq)",
        ],
      },
      {
        subtitle: "3. Negative Sentences - Inkor gaplar",
        colorIndex: 2,
        rules: [
          "📝 PRESENT SIMPLE:",
          ...
          "Example: I didn't go to school yesterday. She didn't call me.",
          "📝 BE VERB:",
          "am not / isn't / aren't / wasn't / weren't",
          "Example: I'm not happy. She isn't ready. They weren't there.",
          "📝 PRESENT PERFECT:",
          "haven't / hasn't + past participle",
          "Example: I haven't seen him. She hasn't finished yet.",
          "📝 MODALS:",
          "can't, won't, couldn't, wouldn't, mustn't, shouldn't",
          "Example: I can't swim. You shouldn't go. He won't come.",
          "📝 DOUBLE NEGATIVE - XATO!",
          "❌ I don't have no money → ✅ I don't have any money",
          "❌ I didn't see nobody → ✅ I didn't see anybody",
        ],
      },
      {
        subtitle: "4. Conjunctions - Bog'lovchilar",
        colorIndex: 3,
        rules: [
          "📝 COORDINATING (FANBOYS):",
          "FOR - chunki: I stayed home, for I was sick",
          "AND - va: I have a cat and a dog",
          "NOR - ham emas: I don't like tea, nor do I like coffee",
          "BUT - lekin: I'm tired but I'll help you",
          "OR - yoki: Do you want tea or coffee?",
          "YET - shunga qaramay: It was cold, yet we went out",
          "SO - shuning uchun: It was raining, so I took an umbrella",
          "📝 SUBORDINATING:",
          "BECAUSE - chunki: I stayed home because I was sick",
          "ALTHOUGH/THOUGH - ga qaramay: Although it was cold, we went out",
          "IF - agar: If you study, you will pass",
          "WHEN - qachonki: When I arrived, they had left",
          "WHILE - paytida: While I was sleeping, the phone rang",
          "BEFORE - oldin: Before you go, call me",
          "AFTER - keyin: After I finish, I'll call you",
          "UNTIL - gacha: Wait until I come back",
          "UNLESS - agar...masa: Unless you hurry, you'll be late",
          "AS SOON AS - ...shi bilan: As soon as I arrive, I'll call you",
        ],
      },
      {
        subtitle: "5. Conditionals - Shart gaplar",
        colorIndex: 4,
        rules: [
          "📝 ZERO CONDITIONAL - Umumiy haqiqatlar:",
          "If + Present Simple, Present Simple",
          "If you heat water, it boils. (Suvni qizdirsang, qaynaydi)",
          "If it rains, the ground gets wet.",
          "📝 FIRST CONDITIONAL - Real kelajak:",
          "If + Present Simple, will + base verb",
          "If you study hard, you will pass. (Yaxshi o'qisang, o'tasan)",
          "If it rains tomorrow, I will stay home.",
          "📝 SECOND CONDITIONAL - Unreal present:",
          "If + Past Simple, would + base verb",
          "If I had money, I would buy a car. (Pulim bo'lsa, mashina olardim)",
          "If I were you, I would accept the offer.",
          "📝 THIRD CONDITIONAL - Unreal past:",
          "If + Past Perfect, would have + past participle",
          "If I had studied, I would have passed. (O'qiganimda, o'tgan bo'lardim)",
      ...
      {
        subtitle: "6. Passive Voice - Majhul nisbat",
        colorIndex: 5,
        rules: [
          "📝 FORMULA: Object + be + past participle (+ by agent)",
          "Active: They build houses → Passive: Houses are built (by them)",
          "📝 PRESENT SIMPLE PASSIVE:",
          "is/are + V3: English is spoken here. Cars are made in Japan.",
          "📝 PAST SIMPLE PASSIVE:",
          "was/were + V3: The book was written in 1990. They were invited.",
          "📝 PRESENT PERFECT PASSIVE:",
          "has/have been + V3: The work has been done. They have been told.",
          "📝 FUTURE PASSIVE:",
          "will be + V3: The letter will be sent tomorrow.",
          "📝 MODAL PASSIVE:",
          "modal + be + V3: It can be done. It must be finished.",
          "📝 QACHON ISHLATILADI:",
          "Bajaruvchi noma'lum: My car was stolen. (Kim o'g'irlagani noma'lum)",
          "Bajaruvchi muhim emas: English is spoken worldwide.",
          "Rasmiy/ilmiy yozuvlarda: The experiment was conducted...",
        ],
      },
      {
        subtitle: "7. Reported Speech - O'zlashtirma gap",
        colorIndex: 0,
        rules: [
      ...
      {
        subtitle: "8. Relative Clauses - Aniqlovchi ergash gaplar",
        colorIndex: 1,
        rules: [
          "📝 DEFINING (muhim ma'lumot):",
          "The man WHO called you is my brother. (Qaysi odam? - bu muhim)",
          "The book WHICH I bought is interesting. (Qaysi kitob? - bu muhim)",
          "The house WHERE I grew up was sold. (Qaysi uy? - bu muhim)",
          "📝 NON-DEFINING (qo'shimcha ma'lumot, vergul bilan):",
          "My brother, WHO lives in London, is a doctor. (Qo'shimcha ma'lumot)",
          "This book, WHICH I bought yesterday, is great.",
          "📝 RELATIVE PRONOUNS:",
          "WHO - odamlar uchun (subject): The girl who won the prize...",
          "WHOM - odamlar uchun (object, formal): The man whom I met...",
          "WHICH - narsalar uchun: The car which I bought...",
          "THAT - ikkalasi uchun (defining only): The book that I read...",
          "WHOSE - egalik: The woman whose car was stolen...",
          "WHERE - joy: The city where I was born...",
          "WHEN - vaqt: The day when we met...",
          "📝 OMITTING RELATIVE PRONOUN:",
          "The book (that/which) I bought... - Object bo'lsa tushirib qoldirish mumkin",
        ],
      },
      {
        subtitle: "9. There is / There are",
        colorIndex: 2,
        rules: [
          "📝 SINGULAR - There is (There's):",
          "There is a book on the table. - Stolda kitob bor.",
          "There is some water in the glass. - Stakanda suv bor.",
          "There was a party last night. - Kecha bayram bo'ldi.",
          "📝 PLURAL - There are:",
          "There are many students here. - Bu yerda ko'p talabalar bor.",
          "There are some apples in the fridge. - Muzlatgichda olmalar bor.",
          "There were many people at the concert. - Konsertda ko'p odam bor edi.",
          "📝 NEGATIVE:",
          "There isn't any milk. - Sut yo'q.",
          "There aren't any books. - Kitoblar yo'q.",
          "There wasn't a meeting. - Uchrashuv bo'lmadi.",
          "📝 QUESTIONS:",
          "Is there a bank near here? - Bu yaqinda bank bormi?",
          "Are there any questions? - Savollar bormi?",
          "How many students are there? - Nechta talaba bor?",
        ],
      },
      {
        subtitle: "10. It as Subject - It egasi sifatida",
        colorIndex: 3,
        rules: [
          "📝 OB-HAVO:",
          "It's sunny today. - Bugun quyoshli.",
          "It's raining. - Yomg'ir yog'yapti.",
          "It was cold yesterday. - Kecha sovuq edi.",
          "📝 VAQT:",
          "It's 5 o'clock. - Soat 5.",
          "It's Monday. - Dushanba.",
          "It's January 1st. - 1-yanvar.",
          "📝 MASOFA:",
          "It's 10 km from here. - Bu yerdan 10 km.",
          "It's a long way to the station. - Bekatgacha uzoq yo'l.",
          "📝 FORMAL IT:",
          "It's important to study. - O'qish muhim.",
          "It seems that he is right. - U to'g'ri ko'rinadi.",
          "It's said that... - ...deyiladi.",
          "It takes 2 hours to get there. - U yerga borishga 2 soat ketadi.",
        ],
      },
      {
        subtitle: "11. Imperative Sentences - Buyruq gaplar",
        colorIndex: 4,
        rules: [
          "📝 POSITIVE COMMANDS:",
          "Open the door! - Eshikni och!",
          "Sit down, please. - Iltimos, o'tiring.",
          "Be quiet! - Jim bo'l!",
          "Come here! - Bu yerga kel!",
          "📝 NEGATIVE COMMANDS:",
          "Don't open the door! - Eshikni ochma!",
          "Don't be late! - Kechikma!",
          "Don't worry! - Xavotir olma!",
          "Never give up! - Hech qachon taslim bo'lma!",
          "📝 LET'S - TAKLIF:",
          "Let's go! - Ketdik!",
          "Let's eat! - Ovqatlanylik!",
          "Let's not argue. - Janjallashmaylik.",
          "📝 POLITE FORMS:",
          "Please sit down. - Iltimos, o'tiring.",
          "Could you open the window? - Derazani ochsangiz bo'ladimi?",
          "Would you mind closing the door? - Eshikni yopsangiz maylimi?",
        ],
      },
      {
        subtitle: "12. Exclamatory Sentences - Undov gaplar",
        colorIndex: 5,
        rules: [
          "📝 WHAT + noun:",
          "What a beautiful day! - Qanday chiroyli kun!",
          "What a nice surprise! - Qanday yoqimli kutilmaganlik!",
          "What an interesting book! - Qanday qiziq kitob!",
          "What beautiful flowers! - Qanday chiroyli gullar! (ko'plik)",
          "📝 HOW + adjective/adverb:",
          "How beautiful! - Qanday chiroyli!",
          "How nice of you! - Sizdan qanday yaxshi!",
          "How quickly he runs! - U qanday tez yuguradi!",
          "How well she sings! - U qanday yaxshi kuylaydi!",
          "📝 SO / SUCH:",
          "It's so hot today! - Bugun juda issiq!",
          "She is such a nice person! - U shunday yaxshi odam!",
          "📝 EVERYDAY EXCLAMATIONS:",
          "Wow! - Voy!",
          "Oh no! - Yo'q-e!",
          "Great! - Ajoyib!",
          "Unbelievable! - Ishonib bo'lmaydi!",
        ],
      },
    ],
  },
